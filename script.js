document.addEventListener("DOMContentLoaded", () => {
  ...
  function ajouterLigneToTable(montext, montant, deleteLigne) {
    ...
    buttonSupprimerLigne.addEventListener("click", function () {
      let alertDeconfirmation = confirm("voulez-vous supprimer cete colonne");
      const supprimerLigne = this.closest("tr");
      if (alertDeconfirmation == true) {
  ...
  function ajouterLigneToTable1(montext1, montant1, deleteLigne1) {
    ...
    `;
 // <button type="button" class="update" id="monSupp2">Modifier</button>
    ...
    buttonSupprimerLigne1.addEventListener("click", function () {
      ...
      let val = confirm("vouler vous supprimer cette colonne");
      if (val == true) {
    ...
    // const ModifiermaLigne = document.querySelector(".update");
    // //const buttonModifierligne1 = tbodyTr1.querySelector(`.${update}`);
    // function update(){
    ...
    // ModifiermaLigne.addEventListener("click", function () {
    //   update()
    //   const ModifieraddForm = document.querySelector("#addForm1");
    //   const ModifiermonButton = document.querySelector(".update");
    //   const ModifiermaValidate = document.querySelector("#validate1");

    //   ModifiermaValidate.onclick = function () {
    //     ModifieraddForm.style.display = "none";
    //   };
    //   ModifiermonButton.onclick = function () {
    //     ModifieraddForm.style.display = "block";
    //   };
    // });

    //.addEventListener("click", function () {
    //   const modifierLigne = this.closest("tr");
    //   modifierLigne.querySelector(".update").textContent;
    // });

    // this.closest("tr").supprimeLigne1.querySelector(".update").addEventListener("click", function () {

    //    })
    //const MontanttoEditRevenu = parseFloat(supprimeLigne1.querySelector('.update').textContent);
    //const supprimeLigne1 = this.closest("tr");
  ...
  function mettreajour() {
    const depenses2 =
      document.getElementById("monprix1Depenses").textContent || 0;
